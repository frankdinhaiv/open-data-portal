...
Depends on: Data Model (00), Vote System (06) | Visual ref: arena-core.html
...
1. On load, system picks exactly 3 random prompts (shuffled across categories)
2. Backend: `GET /api/v1/arena/suggested-prompts?count=3`
3. Returns randomized suggestions; user can click to start battle with that prompt
