...
26. Two action buttons appear below confirmation:
    - "💬 Tiếp tục hội thoại" (Continue Conversation) — visible only if turn limit not reached
    - "⚖️ So sánh tiếp" (New Comparison) — always visible

**Continue Conversation (Multi-Turn After Vote):**
27. User clicks "Tiếp tục hội thoại"
28. Vote highlight and confirmation remain visible in conversation history
29. Input field re-enables for follow-up prompt
30. User submits follow-up; both models receive full conversation context including voted turn
31. New responses appear below previous voted turn
32. User can vote again on the new turn or continue further (up to turn limit)
...
- [ ] After vote, "Tiếp tục hội thoại" button appears if turn limit not reached; re-enables input for follow-up
- [ ] Continue conversation preserves full context including voted turn; both models receive same history
- [ ] "Tiếp tục hội thoại" hidden when turn limit (5) reached
